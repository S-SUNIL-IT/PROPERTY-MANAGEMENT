...
public class EmployeeService {
   ...
   public void AddCustomer(ModelCustomer Add) {
    ...
    public boolean savetenantproperty(Long TenantID,Long PropertyID,Long CreatedBy) {
        ...
        if (TenantPrep.existsByProperty(property)) {
            return false;
        }
    ...
    public List<ModelTenantMapProperty> tenantlist() {
        return TenantPrep.findAll();
    }

    public List<ModelProperty> customerlist() {
        return PropertyRep.findAll();
    }
}
