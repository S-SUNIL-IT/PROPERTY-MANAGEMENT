...
public class ModelTenant {
    ...
    private List<ModelTenantMapProperty> propertyMaps;
    ...
    public List<ModelTenantMapProperty> getPropertyMaps() {
        return propertyMaps;
    }

    public void setPropertyMaps(List<ModelTenantMapProperty> propertyMaps) {
